...
- (void)customizeTabBarImages
{
    ...
    for (int i=0;i < [self.viewControllers count]; i++) {
       ...
       // UIImage *buttonSelectedStateImage = [tabBarSelectedStateImagesArray objectAtIndex:i];
        ...
        tabBarButton.autoresizingMask =UIViewAutoresizingFlexibleWidth| UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleBottomMargin | UIViewAutoresizingFlexibleTopMargin;
...
- (void)customizeTabBarLabels
{
    ...
    for (int i=0;i < [self.viewControllers count]; i++) {
        ...
        tabBarLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:12];
...
- (void)didselectTabAtIndex:(NSUInteger)selectedTabIndex
{
    ...
    for (int i=0; i<[tabBarButtonsArray count]; i++) {
        if (selectedTabIndex==i) {
            ...
            tabBarLabel.textColor = [UIColor greenColor];
            continue;
        }
        UIImage *buttonImage = [tabBarImagesArray objectAtIndex:i];
